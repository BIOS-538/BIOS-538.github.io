...
.pull-left[
![qpcr github](assets/img/qpcr_github.png)
]
...
knitr::include_graphics('assets/img/qPCR_example.png')
knitr::include_graphics('assets/img/growth_curve.png')
```
]
...
knitr::include_graphics('assets/img/flowcyt_example.png')
```
